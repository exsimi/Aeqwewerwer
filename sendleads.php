<?php        
            ...
            $ch = curl_init();
            $url = 'https://api.monsterleads.pro/method/order.add?api_key=9a480b7994bde85ba1f2ddd5ccf2d1f4&format=json&code=r90avf4';
			...
			ToLog($logInfo);            
            if($answer['status'] == 'ok'){
            Header('Location: https://exsimi.github.io/rozetkas2/success.html'); die();
            }else{
                print_r ($answer);
               die();
            }